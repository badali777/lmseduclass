...
<body <?php body_class(); ?>>
<?php if(get_option('lms-academic_free_back_top_top_enable') && get_option('lms-academic_free_back_top_top_enable') == "on" ){ ?>
<!-- Back to top -->
	            	...
	            	<div class="col-md-4">
						<div class="navbar-right">
					        <div class="header-social">
								...
								<ul> <?php
									if($facebook) 
								echo '<a class="social-btn facebook" href="'.esc_url($facebook).'"><i class="fa-brands fa-facebook-f" aria-hidden="true"></i></a>';

							if($twitter) 
								echo '<a class="social-btn twitter" href="'.esc_url($twitter).'"><i class="fa-brands fa-x-twitter" aria-hidden="true"></i></a>';

							if($instagram) 
								echo '<a class="social-btn instagram" href="'.esc_url($instagram).'"><i class="fa-brands fa-instagram" aria-hidden="true"></i></a>'; ?>
				                </ul>
							</div>
