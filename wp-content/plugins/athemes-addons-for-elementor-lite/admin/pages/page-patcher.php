...
<div id="athemes-patcher-options-page">
    <?php if ( ! defined( 'ATHEMES_AFE_PRO_VERSION' ) ) : ?>
        <div class="addons-dashboard-alert addons-dashboard-alert-warning addons-dashboard-alert-with-icon addons-dashboard-alert-with-upsell-link">
            ...
            <a href="<?php echo esc_url( athemes_addons_admin_upgrade_link( 'https://athemes.com/addons', array( 'utm_source' => 'athemes-patcher', 'utm_medium' => 'link', 'utm_campaign' => 'aThemes Addons' ), 'patcher-upgrade-alert-link' ) ); ?>" class="addons-dashboard-external-link" target="_blank">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ( defined( 'ATHEMES_AFE_PRO_VERSION' ) && ! defined( 'ATHEMES_PATCHER_VERSION' ) ) : ?>
									<a class="components-button has-lock-icon css-adm54n addons-dashboard-pro-tooltip addons-install-plugin" href="<?php echo esc_url( athemes_addons_admin_upgrade_link( 'https://athemes.com/addons', array( 'utm_source' => 'athemes-patcher', 'utm_medium' => 'link', 'utm_campaign' => 'aThemes Addons' ), 'patcher-install-patcher-link' ) ); ?>" target="_blank" data-tooltip-message="<?php echo esc_attr__( 'This will install and activate the aThemes Patcher plugin', 'athemes-addons-for-elementor-lite' ); ?>" data-type="external" data-plugin-url="https://patcher.athemes.com/athemes-patcher.zip?nocache=<?php echo esc_attr( time() ); ?>" data-plugin-name="athemes-patcher/athemes-patcher.php" data-redirect-to="<?php echo esc_url( add_query_arg('page', 'athemes-patcher-ap', admin_url('admin.php')) ); ?>">
                                        Install Patcher
                                    </a>
                                <?php else : ?>
									<a class="components-button has-lock-icon css-adm54n addons-dashboard-pro-tooltip" href="<?php echo esc_url( athemes_addons_admin_upgrade_link( 'https://athemes.com/addons', array( 'utm_source' => 'athemes-patcher', 'utm_medium' => 'link', 'utm_campaign' => 'aThemes Addons' ), 'patcher-apply-link' ) ); ?>" target="_blank" data-tooltip-message="<?php echo esc_attr__( 'This is only available on aThemes Addons Pro', 'athemes-addons-for-elementor-lite' ); ?>">
                                        Apply
